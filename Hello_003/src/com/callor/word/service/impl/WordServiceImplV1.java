...
public class WordServiceImplV1 implements WordService {
	 ...
	 * 클래스 생성자에서 wordList를 초기화(생성) 하기
	 * 
	 * 생성자를 통해서 내용이 채워지는 변수나
	 * 초기화 되는 객체는 final 키워드를 부착하여
	 * 다른 method() 에서 변수나 객체를 변형할 수 없도록 하여준다
	 * 
	 * protected : 이 클래스를 장래에 상속을 하여 다른 클래스를 만들었을 때
	 ...
	 * 분해된 단어를 영문과 번역으로 구분하여 WordVO에 담기
	 * WordVO에 담은 단어를 wordList에 추가하기
	 */
